...
public class PokreniTestove {
	...
	public static void main(String[] args) {
		runTestsForClass(autobuska_stanica.PolazakTest.class);
		runTestsForClass(autobuska_stanica.AutobuskaStanicaTest.class);
		runTestsForClass(ispravka_koda.StringIspisivacTest.class);
	}
